         ...
         sensors.each { sensor ->
             ...
             attributes.each { attribute ->
                 ...
                 specialSection("${sensor.displayName} - ${attribute}", 1, "direction"){
                        ...
                        colorSelector("attribute_${sensor.id}_${attribute}_background", "Background Bar", "#3e4475", false);
                        colorSelector("attribute_${sensor.id}_${attribute}_minmax", "Min/Max", "#607c91", false);
                        colorSelector("attribute_${sensor.id}_${attribute}_current", "Current Value", "#8eb6d4", false);
...
def graphSetupPage(){
    ...
    dynamicPage(name: "graphSetupPage") {
        parent.hubiForm_section("General Options", 1){
            ...
            sliderSelector("graph_bar_percent", "Graph Bar Width (1%-100%)", 90, 1, 100, "%");
        ...
        parent.hubiForm_section("Horizontal Axes", 1){
        ...
        specialSection("Device Axes", 1){
            ...
            sliderSelector("graph_v_buffer", "Number of Pixels for Device Name Area", 100, 10, 500, " pixels");
        }
        parent.hubiForm_section("Graph Size", 1){
            //Size
            ...
            if (graph_static_size==true){      
                sliderSelector("graph_h_size", "Horizontal dimension of the graph", 800, 100, 3000, " pixels");
                sliderSelector("graph_v_size", "Vertical dimension of the graph", 600, 100, 3000, " pixels");   
            }
        }
        parent.hubiForm_section("Annotations", 1){
...
def lineSizeSelector(varname, label, defaultSize, min, max){
...
def sliderSelector(varname, label, defaultSize, min, max, units=""){
