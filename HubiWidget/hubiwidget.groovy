definition(
    ...
    description: "Hubitat Widget Creator Parent App",
    category: "My Apps",
    installOnOpen: true,
...
preferences {
    ...
    page(name: "mainPage", title: "Widget Creator", install: true, uninstall: true, submitOnChange: true)
...
def mainPage(){
    ...
    dynamicPage(name: "mainPage"){
       section {
            href name: "setupOpenWeather",  title: "Setup Up Open Weather",       description: "", page: "setupOpenWeather"    
       } 
       section {
            app(name: "kiaUvo",             appName: "Kia UVO",                    namespace: "tchoward", title: "Create Kia UVO App", multiple: false)
            app(name: "hubiWeatherWidget",  appName: "HubiWidget Weather Widget",  namespace: "tchoward", title: "Create New Weather Widget", multiple: true)
            app(name: "hubiGauge",          appName: "HubiWidget Gauge",           namespace: "tchoward", title: "Create New Gauge",          multiple: true)
            app(name: "hubiWeatherTiles",   appName: "HubiWidget Weather Tile",    namespace: "tchoward", title: "Create New Weather Tile",   multiple: true)
            app(name: "hubiRadar",          appName: "HubiWidget Radar Tile",      namespace: "tchoward", title: "Create New Radar Tile",     multiple: true)
            app(name: "hubiPower",          appName: "HubiWidget Solar Widget",    namespace: "tchoward", title: "Create New Power Widget",   multiple: true);
        }
